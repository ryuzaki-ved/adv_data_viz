...
export const BarChartComponent: React.FC<BarChartComponentProps> = ({ data, xAxis, yAxis, normalized, width = '100%', height = 350, xMin, xMax, yMin, yMax }) => {
  ...
  return (
    <div>
      <ResponsiveContainer width={width} height={height}>
        <BarChart data={data} margin={{ top: 10, right: 40, left: 10, bottom: 10 }}>
          ...
          {/* Second bar on right axis if present */}
          {yKeys[1] && (
            <Bar 
              key={yKeys[1]}
          ...
          {/* Third as line on left axis for clarity */}
          {yKeys[2] && (
            <Line 
              key={yKeys[2]}
              type="monotone"
